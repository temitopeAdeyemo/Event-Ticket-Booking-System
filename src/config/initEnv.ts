...
export const jwtAccessTokenSecret = process.env.JWT_ACCESS_TOKEN_SECRET || '03afc0820d376f9fdb1e8fadfefw3902c6f74705feb01f101c480f4205964e3e10';
export const jwtRefreshTokenSecret = process.env.JWT_REFRESH_TOKEN_SECRET || '7bfd6e6512e8ac8b56e31cfbdbe76789efe075039d4a524b2b2ddcb2fb2c69f';
...
const loadEnvVariables = (): void => {
  ...
  Logger.info("All required environment variables are set successfully.");
};
